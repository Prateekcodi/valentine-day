    ...
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-red-50 via-pink-50 to-rose-100">
      ...
      <div className="relative z-10 container max-w-2xl mx-auto px-4 py-16 min-h-screen flex items-center justify-center">
        <GlassCard variant="medium" colored dayTheme={6} className="p-8 text-center">
          <div className="mb-8">
            <div className="text-sm uppercase tracking-widest text-gray-600 mb-2">Day 6 - February 12</div>
            <h1 className="text-4xl font-bold text-gray-900 mb-2" style={{ fontFamily: 'Playfair Display, serif' }}>Kiss Day</h1>
            <p className="text-gray-700">How do you show affection?</p>
          </div>
          <div className="mb-8">
          ...
          {!submitted ? (
            <div className="space-y-6 text-left">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">How do you show love?</label>
              ...
              {/* Message */}
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Tell them more about how you express love</label>
                <textarea
                  value={message}
